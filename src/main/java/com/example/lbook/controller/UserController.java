...
public class UserController {
    ...
    @PutMapping
    public ResponseEntity<ResponseData<String>> updateMe(Principal principal, @RequestBody @Valid UserForm userForm) {
        return ResponseEntity.ok(userService.updateMe(principal, userForm));
    }
    @PutMapping("/change-password")
    public ResponseEntity<ResponseData<String>> changePassword(@RequestBody @Valid ChangePasswordForm request, Principal connectedUser){
